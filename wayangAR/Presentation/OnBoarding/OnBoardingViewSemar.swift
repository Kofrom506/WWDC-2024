...
struct OnboardingViewSemar: View {
    
    @EnvironmentObject var screenRouter: ScreenRouter
    var data: [OnboardingData] = OnboardingData.listSemar
        ...
        GeometryReader { geo in
            ZStack {
                ...
                VStack {
                                ...
                                VStack {
                                    ...
                                    .background(
                                        ZStack(alignment: .top) {
                                            ...
                                            JColor.gradientRedBG.ignoresSafeArea(.all)
                    ...
                    PrimaryButton(title: currentStep < data.count - 1 ? "Continue" : "See Wayang In AR", backgroundColor: JColor.orangePastelNew, foregroundColor: .white,strokeColor: .white){
                        if self.currentStep < data.count - 1 {
                            self.currentStep += 1
                        } else {
                            screenRouter.navigateTo(.wayangViewSemar)
                        }
                    }
